...
def plot_data(data,labels=None):
    ...
    :return:
    """
    cols,marks = ["midnightblue","lightsteelblue","lightcoral", "indigo", "saddlebrown", "midnightblue", "mediumslateblue", "rebeccapurple"],[".","+","*","o","x","^"]
    if labels is None:
...
def plot_frontiere(data,f,step=20):
    ...
    plt.contourf(x,y,f(grid).reshape(x.shape),colors=('blanchedalmond','lavender'),levels=[-1,0,1])
    return plt
